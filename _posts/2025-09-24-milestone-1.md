...
- **Empty net**: It means that defending team has no goalie on the ice (typically when pulled for an extra skater late in the game or during a delayed penalty),
which makes shots far more likely to score. We could get this value  from the situationCode by reading the goalie-presence flags for home and away, if the away-goalie flag is 0 it’s an empty net. 
